...
model = AutoPeftModelForCausalLM.from_pretrained( "./output-0806", device_map="auto", trust_remote_code=True ).eval()

merged_model = model.merge_and_unload()

# merged_model.save_pretrained("./qwen-7b-finetune", max_shard_size="2048MB", safe_serialization=True) # 最大分片2g

merged_model.save_pretrained("./qwen-7b-finetune-0806", safe_serialization=True) # 最大分片2g

tokenizer = AutoTokenizer.from_pretrained( "/home/liutingchao/.cache/modelscope/hub/Qwen/Qwen-7B-Chat", trust_remote_code=True )

tokenizer.save_pretrained("./qwen-7b-finetune-0806")
